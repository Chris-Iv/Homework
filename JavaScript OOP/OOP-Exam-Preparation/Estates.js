function processEstatesAgencyCommands(commands) {
    ...
    var Estate = (function() {
        ...
        var Estate = function Estate(name, area, location, isFurnitured) {
        ...
        Estate.prototype.setArea = function (area) {
            if (!isInteger(area)) {
                throw new TypeError('Area should be an integer number.');
            } else if (area < MIN_AREA || area > MAX_AREA) {
                throw new Error('Area should be in the range [' + MIN_AREA + '...' + MAX_AREA + '].');
            }
        ...
        Estate.prototype.setIsFurnitured = function (isFurnitured) {
            if (typeof (isFurnitured) != 'boolean') {
                throw new TypeError('The value of isFurnitured should be boolean.');
            }
        ...
        Estate.prototype.toString = function () {
          ...
          return this.getType() + ': Name = ' + this.getName() + ', Area = ' + this.getArea() +
    ...
    var BuildingEstate = (function() {
        ...
        var BuildingEstate = function BuildingEstate(name, area, location, isFurnitured, rooms, hasElevator) {
        ...
        BuildingEstate.prototype.setRooms = function (rooms) {
            if (!isInteger(rooms)) {
                throw new TypeError('The number of rooms should be an integer number.');
            } else if (rooms < MIN_ROOMS || rooms > MAX_ROOMS) {
                throw new Error('The number of rooms should be in the range [' +
                    MIN_ROOMS + '...' + MAX_ROOMS + '[.');
            }
        ...
        BuildingEstate.prototype.setHasElevator = function (hasElevator) {
            if (typeof (hasElevator) != 'boolean') {
                throw new TypeError('The value of hasElevator should be boolean.');
            }
    ...
    var Apartment = (function() {
        var Apartment = function Apartment(name, area, location, isFurnitured, rooms, hasElevator) {
    ...
    var Office = (function() {
        var Office = function Office(name, area, location, isFurnitured, rooms, hasElevator) {
            BuildingEstate.apply(this, arguments);
        };
    ...
    var House = (function() {
        ...
        var House = function House(name, area, locations,isFurnitured, floors) {
            Estate.call(this, name, area, locations, isFurnitured);
        ...
        House.prototype.setFloors = function (floors) {
            if (!isInteger(floors)) {
                throw new TypeError('The number of floors should be an integer number.');
            } else if (floors < MIN_FLOORS || floors > MAX_FLOORS) {
                throw new Error('The number of floors should be in the range [' +
    ...
    var Garage = (function() {
        ...
        var Garage = function Garage(name, area, location,isFurnitured, width, height) {
            Estate.call(this, name, area, location, isFurnitured);
            this.setWidth(width);
        ...
        Garage.prototype.setWidth = function (width) {
            if (!isInteger(width)) {
                throw new TypeError('The width should be an integer number.');
            } else if (width < MIN_WIDTH_HEIGHT || width > MAX_WIDTH_HEIGHT) {
                throw new Error('The width should be in the range [' +
        ...
        Garage.prototype.setHeight = function (height) {
            if (!isInteger(height)) {
                throw new TypeError('The height should be an integer number.');
            } else if (height < MIN_WIDTH_HEIGHT || height > MAX_WIDTH_HEIGHT) {
                throw new Error('The height should be in the range [' +
                MIN_WIDTH_HEIGHT + '...' + MAX_WIDTH_HEIGHT + '[.');
            }
        ...
        Garage.prototype.toString = function () {
          return Estate.prototype.toString.call(this) + ', Width: ' +
    ...
    var Offer = (function() {
        ...
        var Offer = function Offer(estate, price) {
        ...
        Offer.prototype.setEstate = function (estate) {
            if (!(estate instanceof Estate)) {
                throw new Error('Estate should be an instance of the Estate class or its subclass.');
            }
        ...
        Offer.prototype.setPrice = function (price) {
            if (!isInteger(price)) {
                throw new TypeError('Price should be an integer number.');
            } else if (price < MIN_PRICE) {
                throw new Error('Price should be higher than ' + MIN_PRICE);
            }
        ...
        Offer.prototype.toString = function () {
          return this.getType() + ': Estate = ' + this.getEstate().getName() +
                  ', Location = ' + this.getEstate().getLocation() + ', Price = ' + this.getPrice();
        };
    ...
    var RentOffer = (function() {
        var RentOffer = function RentOffer(estate, price) {
    ...
    var SaleOffer = (function() {
        var SaleOffer = function SaleOffer(estate, price) {
            Offer.apply(this, arguments);
        };
    ...
    var EstatesEngine = (function() {
        ...
        function executeFindRentsByPriceRangeCommand(minPrice, maxPrice) {
            if (!(isInteger(minPrice)) || !(isInteger(maxPrice))) {
                throw new TypeError('Min and max prices should be integer numbers.');
            }
